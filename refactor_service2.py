...
data class ActivityEntry(
    ...
    chunk2 = """enum class TransferState {
...
data class TransferProgress(
    ...
    chunk3 = """        // Global activity feed — readable by UI without binding to the service
    ...
    chunk4 = """        // Flow to expose active transfers to UI
        val activeTransfersFlow = kotlinx.coroutines.flow.MutableStateFlow<List<TransferProgress>>(emptyList())"""
        
    chunk5 = """    private val activeTransfers = mutableMapOf<String, TransferProgress>()
    ...
    content = content.replace(chunk5, "")
