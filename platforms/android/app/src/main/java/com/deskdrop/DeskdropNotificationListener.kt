...
class DeskdropNotificationListener : NotificationListenerService() {
    ...
    override fun onNotificationPosted(sbn: StatusBarNotification?) {
        ...
        val intent = Intent(this, DeskdropService::class.java).apply {
            action = DeskdropService.ACTION_PUSH_NOTIFICATION
            putExtra(DeskdropService.EXTRA_NOTIFICATION_ID, id)
            putExtra(DeskdropService.EXTRA_NOTIFICATION_PKG, pkg)
            putExtra(DeskdropService.EXTRA_NOTIFICATION_TITLE, title)
