// Deskdrop Windows — Preferences dialog
...
namespace Deskdrop.Windows
{
    internal sealed class PreferencesForm : Form
    {
        ...
        private readonly CheckBox _chkStartOnLogin  = new() { Text = "Start Deskdrop on Windows login", Left = 16, Top = 188, Width = 280, Checked = false };
        ...
        // ── Registry key ─────────────────────────────────────────────────────
        private const string RegKey = @"Software\Deskdrop";

        public PreferencesForm()
        {
            Text = "Deskdrop Preferences";
        ...
        private static void ApplyLoginItem(bool enable)
        {
            ...
            if (enable)
            {
                ...
                if (exePath != null) key.SetValue("Deskdrop", $"\"{exePath}\"");
            }
            else
            {
