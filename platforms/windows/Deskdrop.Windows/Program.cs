...
namespace Deskdrop.Windows
{
    ...
    /// Ensures Windows Firewall has the required inbound exceptions for
    /// Deskdrop discovery and data channels. This covers users running the
    /// portable EXE without the MSI installer.
