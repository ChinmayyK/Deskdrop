...
extension Notification.Name {
    ...
    static let deskdropOpenHistoryPanel = Notification.Name("com.deskdrop.openHistoryPanel")
    static let deskdropOpenCommandPalette = Notification.Name("com.deskdrop.openCommandPalette")
    static let deskdropEnsureDaemon = Notification.Name("com.deskdrop.ensureDaemon")
}
...
final class DeskdropStore: ObservableObject {
    ...
    func openHistoryPanel() {
        ...
        NotificationCenter.default.post(name: .deskdropOpenHistoryPanel, object: nil)
    }

    func openCommandPalette() {
        NotificationCenter.default.post(name: .deskdropOpenCommandPalette, object: nil)
    }
