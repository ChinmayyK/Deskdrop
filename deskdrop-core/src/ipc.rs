...
//!
//! The running daemon exposes a local socket so `deskdrop-cli` can:
...
pub async fn handle_ipc_request(eng: std::sync::Arc<crate::engine::Engine>, req: IpcRequest) -> IpcResponse {
    match req {
        IpcRequest::Status => {
